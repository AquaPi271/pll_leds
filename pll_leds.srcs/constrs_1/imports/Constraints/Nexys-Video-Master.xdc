...
# Set false path between two clocks

# set_false_path -from [get_clocks clk1] -to [get_clocks clk2]

# Use pin, port, cell, or net to ignore their timing paths

# set_false_path -through [get_nets rdData*]
# set_false_path -to [get_pins regA/D]
